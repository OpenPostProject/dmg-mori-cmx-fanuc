...
function onOpen() {
  ...
  mClampModal.format(68); // Default 5th axis modal code to be clamped
...
function onSection() {
  ...
  writeBlock(gAbsIncModal.format(90), gFeedModeModal.format(94), gPlaneModal.format(17), conditional(insertToolCall, formatWords(gFormat.format(49), gFormat.format(40), gFormat.format(80))));
...
function onCommand(command) {
  ...
  case COMMAND_LOCK_MULTI_AXIS:
    ...
    if (getProperty("rotaryTable") == "5axis") {
      writeBlock(mClampModal.format(68));
    }
    return;
  case COMMAND_UNLOCK_MULTI_AXIS:
    writeBlock(mClampModal.format(11));
    if (getProperty("rotaryTable") == "5axis") {
      writeBlock(mClampModal.format(69));
    }
    return;
